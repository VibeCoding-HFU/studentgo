...
export const baseStyles = StyleSheet.create({
  ...
  todayLessonCard: { backgroundColor: '#F9FAFB', borderColor: '#D0D5DD', borderRadius: 8, borderWidth: 1, padding: 10, position: 'relative' },
  ...
  lessonTitle: { color: '#101828', flex: 1, fontSize: 15, fontWeight: '800', paddingRight: 24 },
  ...
  lessonRemoveIconButton: { alignItems: 'center', backgroundColor: '#FEF3F2', borderColor: '#FECDCA', borderRadius: 8, borderWidth: 1, height: 30, justifyContent: 'center', position: 'absolute', right: 8, top: 8, width: 30, zIndex: 2 },
